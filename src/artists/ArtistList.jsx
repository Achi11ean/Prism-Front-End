...
function ArtistList() {
  ...
  useEffect(() => {
    const url = searchTerm
      ? `https://phase4project-xp0u.onrender.com/api/artists/search?name=${searchTerm}`
      : "https://phase4project-xp0u.onrender.com/api/artists";
  ...
  const handleDeleteClick = (artistId) => {
    fetch(`https://phase4project-xp0u.onrender.com/api/artists/${artistId}?user_id=${user.user_id}`, {
      method: "DELETE",
      credentials: 'include'
    })
      .then(() => {
